 ...
 * x and y coordinate values, as defined in the gtypes.h interface.
 *
...
#ifndef _gpathfinder_
#define _gpathfinder_
...
const string kLabelFont = "SansSerif-11"; /* Font for node labels         */
 ...
 * and returns the point where the click took place.
 */

GPoint getMouseClick();

#include "gpathfinder-impl.h"
